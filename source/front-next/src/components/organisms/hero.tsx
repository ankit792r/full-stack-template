import { ArrowUpRight, Badge, CirclePlay, Pill } from "lucide-react";
        ...
        <>
            <div className="max-w-(--breakpoint-xl) w-full flex flex-col lg:flex-row mx-auto items-center justify-between gap-y-14 gap-x-10 px-6 py-12 lg:py-0">
                <div className="max-w-xl">
                    <h1 className="mt-2 max-w-[20ch] text-3xl xs:text-4xl sm:text-5xl lg:text-[2.75rem] xl:text-5xl font-semibold leading-[1.2]! tracking-tight">
